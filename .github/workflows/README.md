...
| `release.yml`         | GitHub Release `vX.Y.Z`                                | Validate tag; attach box+KPI+Desktop+status-api docker.tar.gz |
| `release-github-assets.yml` | workflow_call                                      | Box + KPI + Desktop + status-api docker.tar.gz (attach optional) |
