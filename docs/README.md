...
| d3   | d3_optional_stacks       |

Full setup runs `s1`…`s7`, then installs Docker Engine (`d0`), prepares `/srv/docker` (`d1`), starts Homepage (`d2`), then starts selected extra compose apps (`d3`).
